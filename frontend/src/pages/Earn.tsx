        ...
        <div className="tasks-list" style={{ marginBottom: '24px' }}>
          <TaskCard
            task={{
              ...
              price_per_slot_ton: '5000000000',
              price_per_slot_fiat: '1250.00',
              total_slots: 50,
              completed_slots: 23,
              remaining_slots: 27
            }}
          ...
          <TaskCard
            task={{
              ...
              task_type: 'comment',
              price_per_slot_ton: '3000000000',
              price_per_slot_fiat: '750.00',
              total_slots: 30,
              completed_slots: 15,
              remaining_slots: 15
            }}
          ...
          <TaskCard
            task={{
              ...
              task_type: 'view',
              price_per_slot_ton: '1000000000',
              price_per_slot_fiat: '250.00',
              total_slots: 100,
              completed_slots: 67,
              remaining_slots: 33
            }}
