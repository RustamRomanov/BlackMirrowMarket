...
3.2. Платформа взимает комиссию за использование сервиса.
3.3. Средства зачисляются после проверки выполнения задания.

4. Ответственность
4.1. Платформа не несет ответственности за действия третьих лиц.
4.2. Пользователь несет ответственность за соблюдение правил Telegram.

5. Изменения в Правилах
5.1. Платформа оставляет за собой право изменять Правила.
