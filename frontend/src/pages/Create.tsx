...
export default function Create() {
  ...
  return (
    <div className="create-page">
      ...
      {/* Примеры заданий (всегда показываем) */}
      {!loading && (
        <div className="example-tasks-section">
          <h2>Примеры заданий</h2>
          <div className="example-tasks-list">
          <div className="example-task-card">
            <div className="example-task-header">
              <Bell size={16} color="#4CAF50" />
              <span style={{ color: '#4CAF50', fontWeight: 600 }}>Подписка</span>
              <span className="example-status">Активно</span>
            </div>
            <h4>Подпишитесь на канал о криптовалютах</h4>
            <p>Интересный канал с новостями о блокчейне и криптовалютах. Ежедневные обзоры рынка.</p>
            <div className="example-task-stats">
              <span>Цена: 5 TON</span>
              <span>Слотов: 50</span>
              <span>Выполнено: 23 / 50</span>
            </div>
            <div className="example-task-actions">
              <button className="example-pause-btn">
                <Pause size={14} />
                Пауза
              </button>
              <button className="example-stop-btn">
                Остановить
              </button>
            </div>
          </div>
          ...
          <div className="example-task-card">
            <div className="example-task-header">
              ...
              <span style={{ color: '#2196F3', fontWeight: 600 }}>Комментарий</span>
              <span className="example-status">Активно</span>
            </div>
            <h4>Оставьте комментарий под постом</h4>
            <p>Нужен позитивный комментарий о новой книге автора. Прочитайте пост и оставьте отзыв.</p>
            <div className="example-task-stats">
              <span>Цена: 3 TON</span>
              <span>Слотов: 30</span>
              <span>Выполнено: 15 / 30</span>
            </div>
            <div className="example-task-actions">
              <button className="example-pause-btn">
                <Pause size={14} />
          ...
          <div className="example-task-card">
            <div className="example-task-header">
              ...
              <span style={{ color: '#FF9800', fontWeight: 600 }}>Просмотр</span>
              <span className="example-status">Активно</span>
            </div>
            <h4>Просмотрите публикацию о путешествиях</h4>
            <p>Красивые фотографии и рассказы о путешествиях по миру. Просто откройте и просмотрите.</p>
            <div className="example-task-stats">
              <span>Цена: 1 TON</span>
              <span>Слотов: 100</span>
              <span>Выполнено: 67 / 100</span>
            </div>
            <div className="example-task-actions">
              <button className="example-pause-btn">
                <Pause size={14} />
